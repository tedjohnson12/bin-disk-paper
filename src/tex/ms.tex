...
The value of $p$ is typically taken to be less than 2, so the instability onset occurs at the inner edge of the disk. We use equation (\ref{eq:toomre2}) to find a maximum value for $\Sigma_\text{in}$:
\begin{equation}
