...
We integrate the system, checking its state every 5 orbits of the third body.
We describe the type of orbit by computing the mutual inclination $i$ and the
longitude of the ascending node $\Omega$, which are defined:
...
Where $\bm{L}$ is the angular momentum of the third body.
The coordinate system is defined relative to the binary, with the $z$-axis to be along the
...
The final state of the three-body system is assessed according to two criteria:
...
If neither criteria are true then we do not yet have enough information, and we continue the integration.
...
\begin{figure*}
    \begin{centering}
        \includegraphics[width=1.0\textwidth]{figures/compare_j.pdf}
        \caption{Polar fraction as a function of $e_b$ for various values of $j$.}
        \label{fig:compare_j}
        \script{compare_j.py}
    \end{centering}
\end{figure*}
