...
It is worth noting, however that gravitational instability is inherently a local process. An instability in a single region of the disk will not cause the whole disk to become unstable.
