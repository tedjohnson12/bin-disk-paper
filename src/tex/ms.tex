...
\TJ{(How to account for the changing position of the COM was $f_{\rm b}$ changes? This is used to define the coordinate system)}
...
hydrodynamic simulations by \citep{elsender2023} found that, for binaries with separations on the order of 1 AU, mutual inclinations are seemingly randomly
