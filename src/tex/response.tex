...
\begin{letter}{}
    ...
    \begin{enumerate}
        ...
        \item We have added clarifying language to distinguish prograde/retrograde orbit of the disk from the retrograde/prograde nodal precession the disk undergoes.
    \end{enumerate}
